...
| ⬇️ | **[Windows Desktop](https://github.com/MrBaoboer/PayDance/releases/latest/download/pay-dance-windows-x64.exe)** | Portable EXE with tray, always-on-top, mini float, and auto-start |
